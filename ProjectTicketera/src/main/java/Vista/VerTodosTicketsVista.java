...
public class VerTodosTicketsVista extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VerTodosTicketsVista.class.getName());

    /**
     * Creates new form VerTodosTicketsVista
     */
    public VerTodosTicketsVista() {
        initComponents();
        
    }
    
    public void cargarTickets(List<Ticket> tickets) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista Tickets");
        bg.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Titulo", "Descripcion", "Prioridad", "Estado", "Cliente", "Email"
            }
        ) {
        ...
        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 400, 180));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VerTodosTicketsVista().setVisible(true));
    }
